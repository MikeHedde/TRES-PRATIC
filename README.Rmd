...
Launch the [`make.R`](https://github.com/MikeHedde/TRES-PRATIC/tree/master/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/MikeHedde/TRES-PRATIC/blob/main/CONTRIBUTING.md).
